...
class _RestClient implements RestClient {
  ...
  Future<BaseResponse<HostTokenModel>> verifyHostToken(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<BaseResponse<HostTokenModel>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<BaseResponse<LicenceVerifyModel>> licenceVerify(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<BaseResponse<LicenceVerifyModel>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<BaseResponse<UploadData>> uploadFile(
    ...
    final _options = _setStreamType<BaseResponse<UploadData>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
